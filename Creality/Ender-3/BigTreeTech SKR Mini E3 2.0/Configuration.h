...
#define STRING_CONFIG_H_AUTHOR "(besser, Ender-3)" // Who made the changes.
...
#define MACHINE_UUID "f125ec72-c7b9-4c2d-a6b9-8e6e41fe7baf"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39.8, -12.3, 0 }
